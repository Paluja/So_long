...
/*   Updated: 2024/02/05 18:51:24 by pjimenez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	load_map(t_map *map)
{
	...
	texture = mlx_load_png("/home/paluja/So_long/So_long/src/resized/goblin.png");
	map->img_player = mlx_texture_to_image(map->mlx, texture);
	mlx_delete_texture(texture);
	texture = mlx_load_png("/home/paluja/So_long/So_long/src/resized/gold.png");
	map->img_object = mlx_texture_to_image(map->mlx, texture);
	mlx_delete_texture(texture);
	texture = mlx_load_png("/home/paluja/So_long/So_long/src/resized/path3.png");
	map->img_path = mlx_texture_to_image(map->mlx, texture);
	mlx_delete_texture(texture);
	texture = mlx_load_png("/home/paluja/So_long/So_long/src/resized/Tree.png");
	map->img_wall = mlx_texture_to_image(map->mlx, texture);
	mlx_delete_texture(texture);
	texture = mlx_load_png("/home/paluja/So_long/So_long/src/resized/mine.png");
